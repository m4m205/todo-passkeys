  ...
  <div>
    <div class="d-flex align-center pa-5">
      <v-avatar size="32" class="mr-2">
        <img src="@@/public/images/users/avatar-1.png" width="32" alt="Julia" />
      </v-avatar>
      <div>
      ...
      <div class="ml-auto">
        <v-btn variant="text" color="primary" rounded="sm" icon size="large" @click="clear">
      ...
      <v-window v-model="tab">
        <v-window-item value="111">
          <v-list class="py-0" aria-label="profile list" aria-busy="true">
            ...
            <v-list-item @click="clear" color="secondary" rounded="0">
              <template v-slot:prepend>
