      ...
      <div class="d-flex align-center justify-space-between">
        ...
        <div class="d-flex align-center justify-center flex-wrap flex-row-reverse">
          <v-avatar size="35" variant="outlined" color="surface" class="ml-n2">
            <img src="@@/public/images/users/avatar-4.png" width="35" alt="vector" />
          </v-avatar>
          <v-avatar size="35" variant="outlined" color="surface" class="ml-n2">
            <img src="@@/public/images/users/avatar-3.png" width="35" alt="vector" />
          </v-avatar>
          <v-avatar size="35" variant="outlined" color="surface" class="ml-n2">
            <img src="@@/public/images/users/avatar-2.png" width="35" alt="vector" />
          </v-avatar>
          <v-avatar size="35" variant="outlined" color="surface">
            <img src="@@/public/images/users/avatar-1.png" width="35" alt="vector" />
          </v-avatar>
        </div>
      </div>
